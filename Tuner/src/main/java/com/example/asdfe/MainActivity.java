    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dcode=MediaPlayer.create(MainActivity.this,R.raw.d);
                dcode.start();
            }
        });
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                acode=MediaPlayer.create(MainActivity.this,R.raw.a);
                acode.start();
            }
        });
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ecode=MediaPlayer.create(MainActivity.this,R.raw.e);
                ecode.start();
            }
        });
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gcode=MediaPlayer.create(MainActivity.this,R.raw.g);
                gcode.start();
            }
        });
        btn5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bcode=MediaPlayer.create(MainActivity.this,R.raw.b);
                bcode.start();
            }
        });
        btn6.setOnClickListener(new View.OnClickListener() {@Override
            public void onClick(View v) {
                hecode=MediaPlayer.create(MainActivity.this,R.raw.he);
                hecode.start();
            }
        });
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position){
                    ...
                    case 2:
                        Intent intent1 = new Intent(getApplicationContext(),DropD.class);
                        startActivity(intent1);
                        finish();
                        break;
                    case 3:
                        Intent intent2 = new Intent(getApplicationContext(),DropB.class);
                        startActivity(intent2);
                        finish();
                        break;
                    case 4:
                        Intent intent3 = new Intent(getApplicationContext(),Halfstepdown.class);
